...
const departmentColors: Record<string, { bg: string; border: string }> = {
  Manager:   { bg: "#4f46e5", border: "#3730a3" },
...
const rawNodes: Node[] = [
  { id: "1", type: "employee", data: { name: "Bren Crocker",        role: "IT Manager", department: "Manager",       directReports: ["2","3","4","6","7"], onClick: () => null }, position },
  ...
  { id: "7", type: "employee", data: { name: "Baba Solanke",          role: "IT Support Technician - Level 1",        department: "Support",     directReports: [],onClick: () => null }, position },
  { id: "8", type: "employee", data: { name: "New Hire",         role: "E-commerce Coordinator",  department: "Ecommerce",         directReports: [],      onClick: () => null }, position },
