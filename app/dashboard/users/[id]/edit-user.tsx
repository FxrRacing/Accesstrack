...
export default function EditUser({user, authId, users, locations}: {user: User&{reportsTo: User}, authId: string, users: User[], locations: Location[]}) {
    ...
    return <div>
        ...
        <form action={formAction} className="flex flex-col gap-2 w-1/2 border-2 border-gray-300 p-4">
            ...
            <input type="text" name="department" defaultValue={user.department} className="border-2 border-gray-300 p-2" />
