...
import {  UserHistory, UserProfiles } from "@prisma/client"
...
export type HistoryWithUser = UserHistory & { updatedBy: UserProfiles, user: UserProfiles }
type props = {
                ...
                <div className="flex gap-4 px-6 py-2 space-y-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2">
                      ...
                      <Link href={`/dashboard/staff/${history.updatedById}`} className="text-xs text-muted-foreground mt-2" prefetch={true}>
                        <p className="text-xs text-muted-foreground mt-2">User : {history.updatedBy.fullName}</p>
                      </Link>
                    </div>
                  </div>
                </div>
